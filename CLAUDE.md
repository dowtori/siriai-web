...
6. **§05 Voice** (dark) — 매니페스토 3블록 (Method · Attitude · Outcome). 상단·사이·하단 hr 4개. Block 1 "AI 리터러시적 사고를 기반으로 한 최적의 설계." · Block 2 "도구로서의 AI 접근을 넘어, 니즈를 정확히 이해하고 '사람'을 돕습니다." · Block 3 "평균 +32% 이상의 의사결정 비용 감소를 체험해보세요." 강조 ('사람' · '+32% 이상') fontWeight 600. 영문 매니페스토는 푸터로 echo carry.
