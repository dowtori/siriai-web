...
/**
 * V4 Hero 배경 — GLSL 안개/오로라 + luminous core (원본 구현).
 * 풀스크린 plane(클립공간 정점 셰이더) + frustumCulled=false. ssr:false 전용.
 */
...
const fragmentShader = /* glsl */ `
  ...
  void main(){
    ...
    vec3 glow = vec3(0.34, 0.58, 0.86);     // cool indigo
    ...
    vec3 col = base;
    col += glow * mist * vig * 1.15;                 // 흐르는 안개
    col += glow * core * (0.18 + 0.10 * n);          // luminous core (호흡)
    col *= mix(0.5, 1.0, vig);                        // 가장자리 어둠
