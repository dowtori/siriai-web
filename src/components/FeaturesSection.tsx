...
export default function FeaturesSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative bg-[#111110] min-h-screen flex flex-col py-20 px-8 overflow-hidden"
    >
      {/* subtle grid overlay */}
      <div
      ...
      <div className="relative max-w-6xl mx-auto w-full">
        ...
        <motion.h2
          ...
          style={{ fontSize: "clamp(2rem, 3.2vw, 3.8rem)", wordBreak: "keep-all" }}
        >
          AI와 함께<br />생각하는 방식
        </motion.h2>
      </div>

      {/* center: 3D orbiting carousel */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={inView ? { opacity: 1 } : {}}
        transition={{ duration: 1.2, delay: 0.25 }}
        className="relative flex-1 flex items-center justify-center min-h-[380px]"
      >
        <div className="w-full max-w-2xl">
          <TurntableCarousel height={440} />
        </div>
      </motion.div>
